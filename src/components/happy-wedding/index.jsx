  ...
  return (
    ...
    >
      <div className="container m-auto">
        ...
        <div className="flex items-center justify-center lg:flex-row flex-col mt-10">
          <div className="lg:w-2/5 w-full lg:h-[700px] h-[600px]">
            <Image
          ...
          <div className="lg:mt-0 mt-4 lg:ml-8 ml-0 lg:w-2/5 w-full lg:h-[700px] h-[600px]">
            <Image
